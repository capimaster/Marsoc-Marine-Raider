...
_enemies_three =  [["PATROL_ROADS", 60, "RED", getPos _cacheBuilding, "SAFE", [""], [""]], 15, 40, 3 + round random 3, "patrolGroup_" + _SabotageTask, _enemySide, _faction, "MEN", "RECON", "AAPLANE", "CAR", 2,"STAG COLUMN",true] call CO_fnc_enemyAssault;
_enemies_four = [["PATROL_ROADS", 200, "RED", getPos _cacheBuilding, "SAFE", [""], [""]], 100, 200, 3 + round random 4, "patrolGroup_" + _SabotageTask, _enemySide, _faction, "MEN", "STANDARD", "AAPLANE", "CAR", [4,5,6],"STAG COLUMN",true] call CO_fnc_enemyAssault;
