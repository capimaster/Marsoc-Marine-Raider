...
The<font color='#4169E1' size='18' face=''>centro de reparacion de Vehiculos</font> allows you to fully customize to looks of your vehicles, as well as add functional components to them, such as SLAT cages on armored vehicles. The action to use VAM will appear on your vehicle while it's at one of the depots or the service area.<br></br><br></br>
...
0 = player createDiaryRecord ["Command Ops", ["Base de Operaciones", "In this scenario, the <marker name='base_radius'>main base of operations</marker> is your safe haven. This is where you will start and finish your missions as well as acquire any equipment or vehicle that you might need.<br></br><br></br>
...
<marker name='marker_medical'>el hospital de campaña</marker> allows you to fully heal while you're at the base. It is also used for certain mussions such as rescue ones, as this is where you need to bring the people you've rescued.<br></br><br></br>
<marker name='marker_armory'>ARMERIA</marker> has all of the gear that you might need. Just go in there and talk to the workers, they'll get you sorted quickly. <br></br><br></br>
...
<font color='#FFD700' size='18' face=''>misiones de infanteria</font> are missions designed to be taken head on. These missions are all about large scale urban combat against vast enemy forces.<br></br><br></br>
<font color='#FFD700' size='18' face=''>misiones de reconocimiento</font>  are for those who like to work behind enemy lines. They are designed for teams to  infiltrate the enemy territory, locate their objective, complete the mission and get out before they're overrun.
<br></br><br></br>
<font color='#FFD700' size='18' face=''>Misiones especiales</font> are high risk missions that require precise execution and the highest level of soldier performance. Whether you face a delicate situation, or highly trained enemy special forces, these missions are sure to provide a challenge."],taskNull, "",true];
...
{if (player distance position loadmaster <= 100) then {
 ...
 if (player distance getMarkerPos "marker_hq" <= 15) then {
	drawIcon3D  
	[ 
	"\a3\ui_f\data\map\markers\nato\b_hq.paa", 
	[[0,0.3,0.6,1],[1,1,1,1]], 
